...
public class Task5Test {
    ...
    void parseContactsTest() {
        ...
        resultContactsAsc = Task5.parseContacts(INPUT_CONTACTS, "ASC");
        resultContactsDesc = Task5.parseContacts(INPUT_CONTACTS, "DESC");
        resultContactsSecondAsc = Task5.parseContacts(INPUT_CONTACTS_SECOND, "ASC");
        resultContactsSecondDesc = Task5.parseContacts(INPUT_CONTACTS_SECOND, "DESC");
    ...
    void badInputParseContactsTest() {
        ...
        resultContactsAsc = Task5.parseContacts(null, "ASC");
        resultContactsDesc = Task5.parseContacts(List.of(), "ASC");
